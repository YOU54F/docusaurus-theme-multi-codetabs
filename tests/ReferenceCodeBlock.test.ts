...
test('should parse GitHub reference properly', () => {
    expect(parseReference('https://github.com/you54f/docusaurus-theme-github-codetabs/blob/main/src/theme/ReferenceCodeBlock/index.tsx'))
        .toMatchSnapshot()
    expect(parseReference('https://github.com/you54f/docusaurus-theme-github-codetabs/blob/main/src/theme/ReferenceCodeBlock/index.tsx#L105-L108'))
        .toMatchSnapshot()
})
